    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-6">
                ...
                <img src="img/urun17.jpg" id="ProductImg">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="img/ipad/3.png" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="img/urun17.jpg" class="small-img">
                    </div>
            ...
            <div class="col-6">
                ...
                <p>Şebeke Frekansı: 5G <br>İşlemci Türü: A14 bionic<br>Ekran Boyutu: 6.1 inch<br> Ekran Özellikleri: OLED<br> Ekran Özellikleri: Dokunmatik<br> Ekran Çözünürlüğü: 2532*1170<br>
                </p>
            </div>
        </div>
    </div>
