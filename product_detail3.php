    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-6">
                ...
                <img src="img/mac/5.png" id="ProductImg">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="img/mac/2.png" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="img/mac/3.png" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="img/mac/4.png" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="img/mac/5.png" class="small-img">
                    </div>
            ...
            <div class="col-6">
                <p>Bilgisayar/Macbook Pro</p>
                <h1>Macbook Pro</h1>
                <h4>₺ 17.500</h4>
                <select>
                    <option>Kapasite</option>
                    <option>128 GB</option>
                    <option>256 GB</option>
                    <option>1 TB</option>
                </select>
                <input type="number" value="1">
                <a href="" class="btn3">Sepete Ekle</a>
                <h3>Teknik Özellikler <i class="fa fa-indent"></i></h3>
                <p>Şebeke Frekansı: 5G <br>İşlemci Türü: M1 <br>Ekran Boyutu: 16.1 inch<br> Ekran Özellikleri: OLED<br> <br> Ekran Çözünürlüğü: 2532*1170<br>
                </p>
            </div>
        </div>
    </div>
