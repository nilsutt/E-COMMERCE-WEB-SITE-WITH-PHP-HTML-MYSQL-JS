    ...
    <div class="header">
        <div class="container">
            <div class="navbar">
                ...
                <a href="hakkinda_lang.php"> <img src="img/language.png" width="40px" height="40px"></a>
            </div>
            <div class="row">
                <div class="col-7">
                    <h1> SİPARİŞ ONAYI </h1><br>
                    <p>Siparişiniz alınmıştır. Bizi tercih ettiğiniz için teşekkür ederiz.
                    </p>
