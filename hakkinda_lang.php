    ...
    <div class="header">
        <div class="container">
            ...
            <div class="row">
                <div class="col-7">
                    <h1> HAKKIMIZDA </h1><br>
                    <P>Temellerini 2002 yılında attığımız şirketimiz 18 yıllık yolculuğunda kurduğumuz<br> hayallerle ve hedeflediğimiz başarı basamaklarına bir dünya markası olan<br> Apple’ı bünyesine katarak yatırımlarına devam edip e-ticaret ve mağaza
                        pazarında büyümeye devam etmiştir. <br> <br>Dünyadaki farklı mağaza konseptlerine uygun olarak dizayn edilmiş mağazalarımızda misafirlerimize Apple ürünlerini yakından tanıma fırsatı ve teknik ekibimizle<br> satış sonrası destek
                        sunmaktayız.
                    </P>
